...
**v0.11.3** — 3692+ testes, 84% cobertura, 25/25 fontes com golden tests (21 com dados reais), retry centralizado em 25/25 clients.
...
- **3692+ testes, 84% cobertura** — benchmarks de escalabilidade (memory, volume, cache, async)
